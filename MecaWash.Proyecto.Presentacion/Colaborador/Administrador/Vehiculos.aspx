                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                     ...
                     <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                         <ContentTemplate>
                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" GridLines="None" ShowFooter="True" CssClass="table" AllowPaging="True" DataKeyNames="IDCita" EmptyDataText="No hay datos disponibles" PageSize="6">
                        <Columns>
