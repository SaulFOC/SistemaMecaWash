...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="contedor1 pt-3 pb-3">
       ...
       <%-- <div class="modal fade" id="addServicioVehiculo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel1">Servicios</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                            <ContentTemplate>
                                <div class="row">
                                        <asp:TextBox ID="txtId" CssClass="form-control" runat="server" Visible="true"></asp:TextBox>
                                    <div class="col-6">
                                        <label>Añadir Servicio</label>
                                        <asp:DropDownList ID="ddlServicio" AutoPostBack="true" runat="server" CssClass="w-100" AppendDataBoundItems="true">
                                            <asp:ListItem Value="gg">buscar...</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-6">
                                        <label class="w-100 text-truncate">Vehiculo</label>
                                        <asp:TextBox ID="txtPrecioServicio" runat="server" Enabled="false" CssClass="form-control w-100"></asp:TextBox>
                                    </div>
                                </div>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" GridLines="None" ShowFooter="True" CssClass="table" AllowPaging="True" DataKeyNames="IDCita" EmptyDataText="No hay servicios registrados" PageSize="6">
                                    <Columns>
                                        <asp:TemplateField HeaderText="ID" ControlStyle-Width="30px" Visible="true">
                                            <ItemTemplate>
                                                <asp:Label ID="lblId" CssClass="text-truncate" runat="server" Text='<%# Bind("IDCita") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Servicio" ControlStyle-Width="30px" Visible="true">
                                            <ItemTemplate>
                                                <asp:Label ID="lblServicio" CssClass="text-truncate" runat="server" Text='<%# Bind("IDServicio") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Total" ControlStyle-Width="30px" Visible="true">
                                            <ItemTemplate>
                                                <asp:Label ID="lblTotal" CssClass="text-truncate" runat="server" Text='<%# Bind("Total") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button>
                        <asp:Button ID="Button3" runat="server" Text="Button" CommandName="InsertarbdServicio" OnCommand="agregabdservicio" CssClass="btn btn-info" />
                    </div>
                </div>
            </div>
        </div>--%>
