...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container w-100 pt-3 pb-3">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" GridLines="None" ShowFooter="True" CssClass="table" AllowPaging="True" DataKeyNames="IDEmpleado" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowCommand="GridView1_RowCommand" OnRowEditing="GridView1_RowEditing">
            <AlternatingRowStyle />
            <Columns>
                <asp:TemplateField HeaderText="COD" ControlStyle-Width="50px">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="DNI" ControlStyle-Width="140px">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="Clave" ControlStyle-Width="160px">
                    <EditItemTemplate>
                        <asp:TextBox ID="txtClaveE" CssClass="form-control" runat="server" Text='<%# Bind("Contraseña") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <FooterTemplate>
                        <asp:TextBox ID="txtClave" CssClass="form-control" placeholder="********" runat="server"></asp:TextBox>
                    </FooterTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Apellido" ControlStyle-Width="180px">
                    <EditItemTemplate>
                        <asp:TextBox ID="txtApellidoE" CssClass="form-control" runat="server" Text='<%# Bind("Apellido") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <FooterTemplate>
                        <asp:TextBox ID="txtApellido" placeholder="Apellido" CssClass="form-control" runat="server"></asp:TextBox>
                    </FooterTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label6" CssClass="text-truncate" runat="server" Text='<%# Bind("Apellido") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Correo" ControlStyle-Width="300px">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="Puesto" ControlStyle-Width="180px">
                    <EditItemTemplate>
                ...
                <asp:CommandField ShowEditButton="True" EditImageUrl="../../assets/img/editar.svg" ButtonType="Image" >

                <ControlStyle CssClass="btn btn-warning" />
                </asp:CommandField>
                <asp:CommandField ButtonType="Image" DeleteImageUrl="../../assets/img/eliminar.svg" ShowDeleteButton="True">
